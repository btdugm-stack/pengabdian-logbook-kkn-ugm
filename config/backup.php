...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        // Nama folder tujuan backup - bukan langsung APP_NAME karena
        // "Pengabdian: Logbook KKN" mengandung ":" yang tidak valid sebagai
        // nama folder di Windows.
        'name' => env('BACKUP_ARCHIVE_NAME', 'logbook-kkn'),
        ...
        'destination' => [
             ...
             */
            // Audit §env: konstanta kelas ZipArchive memicu autoload saat config
            // dievaluasi (tiap request bila config belum di-cache) -> fatal di SAPI
            // PHP tanpa ekstensi zip, padahal fitur backup tidak dipakai.
            'compression_method' => class_exists('ZipArchive') ? ZipArchive::CM_DEFAULT : -1,
